...
!!! note
    The free tier allows up to 3 custom buttons. The **+** button is greyed out once the limit is reached. [Commandeck Pro](../pro.md) removes this limit.
...
- **About Commandeck** — version and license info
