...
!!! note
    La version gratuite autorise jusqu'à 3 boutons personnalisés. Le bouton **+** est grisé une fois la limite atteinte. [Commandeck Pro](../pro.md) supprime cette limite.
...
- **À propos de Commandeck** — informations sur la version et la licence
