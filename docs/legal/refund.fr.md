...
Les remboursements sont traités dans les 5 jours ouvrables.

## Après un remboursement

Après remboursement, votre clé de licence Pro sera désactivée et les fonctionnalités Pro ne seront plus accessibles. Vos boutons et votre configuration ne sont pas supprimés — vous conservez un accès complet à la version gratuite.
