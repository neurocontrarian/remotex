...
These Terms are entered into with the operator of RemoteX, doing business as **neurocontrarian**, located in Québec, Canada. Payments are processed by [LemonSqueezy](https://www.lemonsqueezy.com), acting as Merchant of Record — they handle VAT, sales tax, invoicing and chargeback management on behalf of the author.

**Contact:** [neurocontrarian@gmail.com](mailto:neurocontrarian@gmail.com)

## 1. Acceptance

By downloading, installing, or using RemoteX ("the Software"), you agree to these Terms of Service. If you do not agree, do not use the Software.

## 2. License

**Free tier.** RemoteX is open-source software licensed under the MIT License. The source code is available at [github.com/neurocontrarian/remotex](https://github.com/neurocontrarian/remotex). You may use, copy, modify, and distribute the free-tier software under the terms of the MIT License.

**Pro features.** The Pro module (`src/pro/`) is proprietary software. Purchasing a Pro license grants you a personal, non-transferable, non-exclusive right to use the Pro features on up to **3 devices simultaneously** that you own or control.
