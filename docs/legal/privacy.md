...
Commandeck is operated by **neurocontrarian**, located in Québec, Canada. Payment processing is handled by [LemonSqueezy](https://www.lemonsqueezy.com) acting as Merchant of Record — they are responsible for all customer payment data.

The author does not operate any server collecting user data: license validation is performed directly between your machine and LemonSqueezy's API. The author has no access to user purchase information beyond aggregate sales reports from LemonSqueezy.

**Contact for any privacy inquiry:** [neurocontrarian@gmail.com](mailto:neurocontrarian@gmail.com)

## What data we collect

Commandeck collects minimal data, strictly necessary for license validation.
...
Commandeck stores the following files in `~/.config/commandeck/`:
...
License validation is handled by [LemonSqueezy](https://www.lemonsqueezy.com). Their privacy policy applies to data they process. Validation calls are made at activation and at most once every 30 days when the app is running. The app works fully offline between checks — only your license key and device ID are sent.
...
For any question or to exercise your data-protection rights: [neurocontrarian@gmail.com](mailto:neurocontrarian@gmail.com)
